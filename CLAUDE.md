...
## Recent Changes
- 002-todo-external-sources: Added Go 1.25.0 + Bubble Tea v1.3.10 (TUI), Bubbles v1.0.0 (components), Huh v0.8.0 (forms), Lip Gloss v1.1.0 (styling), sqlx v1.4.0 (database), modernc.org/sqlite v1.45.0

- 001-terminal-task-manager: Added Go 1.22+ + Bubble Tea v1.x (TUI), Lip Gloss v1.x (styling), Bubbles v0.20+ (components), Huh v0.6+ (forms), Glamour (markdown rendering)
